              ...
              <Card>
                ...
                {(candidate.linkedInUrl || candidate.gitHubUrl) && (
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <p className="text-xs text-gray-500 mb-2">Profile Links</p>
                    <div className="flex flex-wrap gap-2">
                      {candidate.linkedInUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors"
                        >
